  ...
  return (
    <div id="scoresContainer">
      <div className="scoreItem">
        <div className="scoreImageContainer">{<img src="/assets/images/person.png" alt="person" className="personImage" />}</div>
      ...
      <div className="scoreItem">
        <div className="scoreImageContainer"><img src="/assets/images/car.png" alt="car" className="carImage" /></div>
